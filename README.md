...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1800 200">
  ...
  <defs>
    ...
    <pattern id="circuitPattern" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
      <path d="M10 10 L50 10 M30 10 L30 50 M10 30 L50 30 M10 50 L50 50" 
            stroke="#0066cc" stroke-width="1" fill="none" opacity="0.1"/>
    </pattern>
  </defs>

  <!-- Main background -->
  <rect width="1800" height="200" fill="url(#backgroundGradient)"/>
  
  <!-- Circuit pattern overlay -->
  <rect width="1800" height="200" fill="url(#circuitPattern)"/>

  <!-- Decorative code brackets -->
  <path d="M400 50 L350 100 L400 150" stroke="#00ffcc" stroke-width="4" fill="none"/>
  <path d="M1400 50 L1450 100 L1400 150" stroke="#00ffcc" stroke-width="4" fill="none"/>

  <!-- Main text -->
  <text x="900" y="115" text-anchor="middle" 
